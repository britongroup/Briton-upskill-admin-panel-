...
import Courses from 'pages/apps/courses/Courses';
import CreateCourse from 'pages/apps/courses/create-course/CreateCourse';
import CreateService from 'pages/apps/services/create-service/CreateService';
import Services from 'pages/apps/services/Services';
import EditService from 'pages/apps/services/edit-service/EditService';
import Training from 'pages/apps/training/Training';
import CreateTraining from 'pages/apps/training/create-training/CreateTraining';
import EditTraining from 'pages/apps/training/edit-training/EditTraining'
...
const EditCourse = Loadable(lazy(() => import('pages/apps/courses/editcourse/EditCourse')));
// render - sample page
// const SamplePage = Loadable(lazy(() => import('pages/extra-pages/sample-page')));
const Landing = Loadable(lazy(() => import('pages/landing')));
const ContactUS = Loadable(lazy(() => import('pages/contact-us')));
const CreateBlog = Loadable(lazy(() => import('pages/apps/blog/create-blog/CreateBlog')));
const EditBlog = Loadable(lazy(() => import('pages/apps/blog/edit-blog/EditBlog')));
const Faq = Loadable(lazy(() => import('pages/apps/faq/Faq')));
const Enquiries = Loadable(lazy(() => import('pages/apps/enquiries/Enquiries')));
