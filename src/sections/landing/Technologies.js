...
const Technologies = [
  {
    ...
    icon: techBootstrap,
    title: 'Bootstrap 5',
    description: "Doledge - Boost your project's visual appeal and functionality with our Bootstrap 5 dashboard template.",
  ...
  },
  {
    ...
    description:
      'Doledge React dashboard template is a powerful tool that utilizes the Material-UI component library to create stunning and intuitive user interfaces.',
  ...
  },
  {
    ...
    title: 'Asp.net',
    description:
      'Doledge .NET version is a robust dashboard template designed specifically for .NET developers. Its comes with a wide range of pre-built components.',
  ...
  },
  {
    ...
    title: 'CodeIgniter',
    description:
      'Doledge CodeIgniter version is a powerful dashboard template built specifically for developers who use the CodeIgniter PHP framework.',
  ...
  },
  {
    ...
    title: 'Figma',
    description:
      'Doledge comes with a Figma design file that allows you to customize and fine-tune your dashboard to meet your specific needs.',
    preview:
        ...
        <Grid item xs={12}>
          <Grid container spacing={2} sx={{ textAlign: 'center', marginBottom: 3 }}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Typography>Explore the Demos of Doledge in multiple technologies.</Typography>
              </motion.div>
            </Grid>
          </Grid>
        </Grid>
