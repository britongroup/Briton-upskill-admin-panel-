...
const Technologies = [
  {
    ...
    description: 'Check the live preview of Doledge Figma design file. Figma file included in all licenses.',
    preview:
  ...
  },
  {
    ...
    description: 'Access all components of Doledge in one place to make your development work easier.',
        ...
        <Grid item xs={12}>
          <Grid container spacing={2} justifyContent="center" sx={{ textAlign: 'center', marginBottom: 3 }}>
            ...
            <Grid item xs={12} md={7}>
              ...
              >
                <Typography>
                  Doledge caters to the needs of both developers and designers, whether they are beginners or experts.
                </Typography>
              </motion.div>
            </Grid>
          </Grid>
